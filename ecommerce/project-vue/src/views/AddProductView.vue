    ...
    <div class="min-h-screen flex items-center justify-center border-t border-gray-100">
      <div class="border mt-2 p-6 rounded-md w-full md:w-2/3 lg:w-1/2 xl:w-1/3">
        ...
        <div v-if="!submitted">
          <form>
            ...
            <div class="mb-4">
              ...
              <input type="text" id="productPrice" class="mt-1 p-2 border w-full rounded-md" v-model="product.price" />
            </div>
            <div class="mb-4">
        ...
        <div v-else>
          ...
          <button type="button" @click="newProduct"  class="w-full bg-green-500 text-white p-2 rounded-md hover:bg-green-600">
            New Product
          </button>
        </div>
      </div>
